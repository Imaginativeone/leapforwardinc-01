<?php 
  ...
  function university_files() {
    ...
    if (strstr($_SERVER['SERVER_NAME'], 'http://leapforward01.local/')) {
      ...
      wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.197eea0fa9c088f2f34e.js'), NULL, '1.0', true);
      wp_enqueue_style ('our-main-styles',    get_theme_file_uri('/bundled-assets/styles.197eea0fa9c088f2f34e.css'));
