<?php 
  ...
  function university_files() {
    ...
    if (strstr($_SERVER['SERVER_NAME'], 'http://leapforward01.local/')) {
      ...
      wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.3f90f2f396d2096ad109.js'), NULL, '1.0', true);
      wp_enqueue_style ('our-main-styles',    get_theme_file_uri('/bundled-assets/styles.3f90f2f396d2096ad109.css'));
